        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10">
                                @if($competition->image)
                                    <img class="h-10 w-10 rounded-full object-cover" src="{{ asset('storage/' . $competition->image) }}" alt="{{ $competition->name }}" loading="lazy">
                                @else
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        {{ $competition->registration_end ? \Carbon\Carbon::parse($competition->registration_end)->format('d M Y') : '-' }}
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
