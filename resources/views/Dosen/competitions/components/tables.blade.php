                ...
                <tr class="hover:bg-gray-50 transition-colors" 
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <div class="flex justify-end gap-2">
                                <a href="{{ route('lecturer.competitions.sub-competitions.index', $competition->id) }}" class="btn btn-sm btn-ghost text-purple-600 hover:bg-purple-50 transition-colors relative" title="Lihat Sub-Kompetisi">
                ...
                <tr>
                    <td colspan="9" class="px-6 py-10 text-center text-gray-500">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <p class="text-gray-500 mt-1 text-sm">Silakan ubah filter pencarian</p>
                        </div>
                    </td>
                </tr>
                @endforelse
