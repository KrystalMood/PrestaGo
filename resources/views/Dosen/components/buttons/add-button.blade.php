...
@php
    $icons = [
        ...
        'user-plus' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 017.75 3.97M18 21H6a2 2 0 01-2-2v-1a6 6 0 0112 0v1a2 2 0 01-2 2z" />'
    ];
@endphp
