            ...
            @component('admin.components.cards.card', ['title' => 'Informasi Rekomendasi'])
                <div class="space-y-6">
                    ...
                    <div class="border-t border-gray-200 pt-4 mt-4">
                        <form method="POST" action="{{ route('admin.recommendations.destroy', $recommendation->id) }}" class="delete-recommendation-form">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const deleteForm = document.querySelector('.delete-recommendation-form');
        if (deleteForm) {
