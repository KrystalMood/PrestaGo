@props(['stats' => [], 'columns' => 4])

<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-{{ $columns }} gap-4 mb-6">
    @foreach($stats as $stat)
    <div class="bg-white overflow-hidden rounded-lg shadow-custom transition-all duration-300 hover:shadow-lg">
        <div class="p-5 flex items-center">
            ...
            <div class="flex-shrink-0 {{ $iconColor }} rounded-full p-3 mr-4 transform transition-transform duration-300 hover:scale-110">
                @if($icon === 'user')
        ...
        <div class="h-1 w-full bg-gray-100">
            <div class="h-full {{ $iconColor }} transition-all duration-500" style="width: {{ min(100, ($stat['value'] ?? 0)) }}%"></div>
        </div>
    </div>
    @endforeach
</div> 