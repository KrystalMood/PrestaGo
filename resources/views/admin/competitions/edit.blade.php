@component('layouts.admin', ['title' => 'Edit Kompetisi'])
    <div class="bg-white rounded-lg shadow-custom p-6">
        @component('admin.users.components.page-header')
            @slot('subtitle', 'Perbarui detail kompetisi dengan menggunakan formulir di bawah ini.')
        ...
        @if(isset($competition) && $competition->exists)
        <div class="mt-8">
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex justify-between items-center p-4 border-b border-gray-200">
                    <p class="text-sm text-gray-600">Kelola peserta yang terdaftar untuk kompetisi ini.</p>
                    <a href="{{ route('admin.competitions.participants', $competition->id) }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                            ...
                            @foreach($competition->participants as $participant)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('admin.competitions.participants', $competition->id) }}" class="text-blue-600 hover:text-blue-900">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="p-6 text-center bg-gray-50 rounded-b-lg">
                    <p class="text-gray-500">Belum ada peserta untuk kompetisi ini.</p>
                </div>
                @endif
            </div>
        </div>
