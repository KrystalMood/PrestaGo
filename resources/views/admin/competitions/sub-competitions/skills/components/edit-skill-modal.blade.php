    ...
    <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white rounded-xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            ...
            <div id="edit-skill-skeleton" class="hidden p-6 space-y-5">
                <!-- Skill Name Skeleton -->
                <div>
                    <div class="block text-sm font-medium text-gray-700 mb-1.5">Nama Skill</div>
                    <div class="h-10 bg-gray-200 rounded-lg animate-pulse"></div>
                    <div class="mt-1.5 h-4 bg-gray-200 rounded w-2/3 animate-pulse"></div>
                </div>
            ...
            <form id="edit-skill-form">
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Nama Skill</label>
                        <div class="mt-1 relative">
                            <input type="text" class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm bg-gray-50 focus:outline-none sm:text-sm" id="edit_skill_name" disabled>
                        </div>
                        <p class="mt-1.5 text-sm text-gray-500">
                            Nama skill tidak dapat diubah
                        </p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <input type="number" class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="edit_weight_value" name="weight_value" step="0.01">
                        </div>
                        <p class="mt-1.5 text-sm text-gray-500">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            <select class="block w-full px-3 py-2.5 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm" id="edit_criterion_type" name="criterion_type">
                ...
                <div class="bg-gray-50 px-6 py-4 flex justify-end space-x-3 border-t border-gray-200 rounded-b-xl">
                    ...
                    <button type="submit" id="submit-edit-skill" class="inline-flex justify-center py-2.5 px-5 border border-transparent shadow-sm text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200">Update Skill</button>
                </div>
            </form>
        </div>
    </div>
