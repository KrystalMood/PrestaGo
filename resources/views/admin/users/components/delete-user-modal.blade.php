@props(['modalId' => 'delete-user-modal'])
    ...
    <div class="bg-white rounded-lg shadow-lg max-w-md w-full mx-4" id="delete-modal-container">
        <div class="p-6">
            ...
            <div class="text-center py-4">
                ...
                <h3 class="mb-3 text-lg font-medium text-gray-900">Yakin ingin menghapus pengguna ini?</h3>
                <p class="mb-5 text-sm text-gray-500">Tindakan ini tidak dapat dibatalkan dan semua data terkait pengguna ini akan dihapus secara permanen.</p>
                
                <form id="delete-user-form" action="" method="POST" class="mt-6">
                    @csrf
                    @method('DELETE')
