@component('layouts.admin', ['title' => 'Edit Program Studi'])
    <div class="bg-white rounded-lg shadow-custom p-6">
        <div class="mb-6">
            @include('admin.components.ui.page-header', [
                'title' => 'Edit Program Studi',
                'subtitle' => 'Edit data program studi yang sudah ada.',
        ...
        <form action="{{ route('admin.programs.update', $program->id) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                ...
                <x-ui.form-input
                    ...
                    :value="old('faculty', $program->faculty)"
                    required
                ...
                <x-ui.form-select
                    ...
                    :selected="old('degree_level', $program->degree_level)"
                    required
            ...
            <div class="form-group mb-4 mt-4">
                <div class="flex items-center">
                    <input type="checkbox" name="is_active" id="is_active" class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" {{ old('is_active', $program->is_active) ? 'checked' : '' }}>
