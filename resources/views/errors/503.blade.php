...
<body class="font-sans antialiased bg-white min-h-screen flex flex-col items-center justify-center p-4">
    <div class="max-w-md mx-auto text-center">
        <div class="py-6">
            <h2 class="text-indigo-500 text-2xl font-semibold mb-4">503</h2>
            
            <img src="{{ asset('images/errors.png') }}" alt="Error Illustration" class="w-auto h-48 mx-auto mb-5 object-contain">

            <h1 class="text-4xl font-bold text-gray-800 mb-3">Layanan Tidak Tersedia</h1>
            
            <p class="text-gray-600 mb-6">Maaf, saat ini kami sedang melakukan pemeliharaan sistem. Silakan coba kembali nanti.</p>
