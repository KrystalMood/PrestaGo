@component('layouts.mahasiswa', ['title' => 'Pengaturan'])
    <div class="bg-white rounded-lg shadow-custom p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="border border-gray-100 rounded-lg p-5 hover:bg-gray-50 transition-colors">
                <h3 class="font-medium text-gray-800 mb-3">Akun Profile</h3>
                <p class="text-sm text-gray-600 mb-4"> Atur nama profile, foto profile. </p>
                <a href="{{ route('Mahasiswa.profile.index') }}" class="px-4 py-2 bg-blue-600 text-white rounded-md">
                    Lihat Pengaturan
                </a>
            </div>
