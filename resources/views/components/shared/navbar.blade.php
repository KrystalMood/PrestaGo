                ...
                <div class="relative ml-4">
                    <div class="dropdown dropdown-end">
                        <div tabindex="0" role="button" class="flex items-center cursor-pointer">
                            <img class="h-8 w-8 rounded-full border-2 border-gray-200" src="https://ui-avatars.com/api/?name={{ $user ? urlencode($user->name) : 'User' }}&background=4338ca&color=fff" alt="User avatar" />
