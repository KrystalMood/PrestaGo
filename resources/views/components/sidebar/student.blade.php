...
<li>
    <a href="{{ route('student.recommendations.index') }}" class="flex items-center p-3 rounded-lg {{ request()->routeIs('student.recommendations.*') ? 'bg-brand-light bg-opacity-10 text-brand' : 'hover:bg-gray-100 text-gray-700' }}">
        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
