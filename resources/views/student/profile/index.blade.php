@component('layouts.mahasiswa', ['title' => 'Profil Mahasiswa'])
    <div class="max-w-5xl mx-auto">
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6 border border-gray-100">
            ...
            <div id="personal-info-content" class="tab-content block">
                <form id="profile-form" method="POST" action="{{ route('student.profile.update') }}" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                        ...
                        <div class="md:w-3/4 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="nim" name="nim" class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 bg-gray-50" value="{{ $user->nim }}" readonly disabled>
            ...
            <div id="skills-content" class="tab-content hidden">
                <form id="skills-form" method="POST" action="{{ route('student.profile.skills.update') }}" class="space-y-6">
                    @csrf
            ...
            <div id="interests-content" class="tab-content hidden">
                <form id="interests-form" method="POST" action="{{ route('student.profile.interests.update') }}" class="space-y-6">
                    @csrf
                    
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900">Daftar Bidang Minat</h3>
                            <p class="text-sm text-gray-600 mt-1">Bidang yang Anda minati dan tingkat ketertarikan Anda</p>
                        </div>
