@props(['title' => 'Daftar Kompetisi', 'subtitle' => null, 'showBackButton' => false, 'backRoute' => null, 'actionText' => null, 'actionRoute' => null, 'actionIcon' => null, 'useModal' => false, 'modalId' => null])
...
<div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
    <div>
        ...
        @else
            <p class="mt-1 text-sm text-gray-500">Halaman ini menampilkan daftar kompetisi yang tersedia untuk mahasiswa.</p>
        @endif
    </div>
